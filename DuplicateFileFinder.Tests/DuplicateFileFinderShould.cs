...
namespace DuplicateFileFinder.Tests
{
    ...
    internal class DuplicateFileFinderShould
    {
        ...
        public void Find_Duplicate_File_By_Name()
        {
            ...
            Assert.That(duplicates.First(d => d.Identifier.Equals(duplicateFileName1)).Count, Is.EqualTo(3));
            Assert.That(duplicates.First(d => d.Identifier.Equals(duplicateFileName2)).Count, Is.EqualTo(6));
        }
    }
}
